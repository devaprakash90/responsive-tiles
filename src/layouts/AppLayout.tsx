...
import { Home, BarChart, Files, Calendar, ClipboardList } from 'lucide-react';
    ...
    <div className="min-h-screen flex flex-col">
        ...
        <div className="container flex h-16 items-center justify-between px-4 md:px-6">
          <div className="flex items-center gap-2">
            <Link to="/" className="flex items-center gap-2">
              <img 
                src="https://strapi.tarento.com/uploads/Tarento_logo_749f934596.svg" 
                alt="Tarento Logo" 
                className="h-8" 
              />
              <span className="font-medium">SIEM Logs Analyzer</span>
            </Link>
          </div>
      ...
      <footer className="py-6 border-t">
        <div className="container flex flex-col md:flex-row items-center justify-between gap-4 px-4 md:px-6 text-sm text-muted-foreground">
          <p>© 2023 SIEM Logs Analyzer. All rights reserved.</p>
